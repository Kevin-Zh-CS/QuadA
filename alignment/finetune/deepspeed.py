...
from alignment.configs import get_deepspeed_train_config
from alignment.datasets import parse_dataset
from alignment.finetune.trainer import SupervisedFinetuneTrainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module alignment.finetune.deepspeed',
