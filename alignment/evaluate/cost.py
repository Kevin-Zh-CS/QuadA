...
from alignment.configs import get_deepspeed_eval_config
from alignment.datasets import SafetyPreferenceDataset, parse_dataset
from alignment.logger import set_logger_level
from alignment.models import AutoModelForScore, load_pretrained_models
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module alignment.evaluate.cost',
