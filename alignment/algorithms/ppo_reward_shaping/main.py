...
from alignment.algorithms.ppo_reward_shaping.trainer import PPORewardShapingTrainer
from alignment.configs import get_deepspeed_eval_config, get_deepspeed_train_config
from alignment.datasets import parse_dataset
from alignment.logger import set_logger_level
from alignment.utils import seed_everything, str2bool


def parse_arguments() -> argparse.Namespace:
    """Parse the command-line arguments."""
    parser = argparse.ArgumentParser(
        prog='deepspeed --module alignment.algorithms.ppo_lag',
